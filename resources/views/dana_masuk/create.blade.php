    ...
    <form action='{{ url('dana_masuk') }}' method='post'>
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" name='nominal' value="{{ Session::get('nominal') }}"
                        id="nominal">
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name='ket_pemasukan'
                        value="{{ Session::get('ket_pemasukan') }}" id="ket_pemasukan">
                </div>
            </div>
            <div class="mb-3 row">
